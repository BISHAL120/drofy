    ...
    <div className="order-failed-container">
      <div className={`order-failed-content ${isVisible ? "fade-in" : ""}`}>
        ...
        <div className="error-explanation">
          <p>
            We encountered an issue processing your payment for order
            #ORD-2024-12345. This could be due to insufficient funds, an expired
            card, or a temporary network issue.
          </p>
          <p>
            Don&apos;t worry – your items are still in your cart and no charges
            were made.
          </p>
        </div>
        ...
        <div className="button-group">
          <button
            ...
            aria-label="Try processing the order again"
          >
            <span>Try Again</span>
          </button>
