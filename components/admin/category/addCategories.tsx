...
export default function AddCategoryPage({
  ...
  function onSubmit(values: z.infer<typeof categorySchema>) {
    ...
    if (initialData) {
      axios
        .patch(`/api/admin/categories/${initialData.id}`, formdata)
        .then((response) => {
        ...
        <div className="flex items-center justify-between space-x-4">
          ...
          <div>
            <Button
              ...
              className={
                initialData ? "bg-green-600 hover:bg-green-500 text-white" : ""
              }
            >
              {isLoading ? (
