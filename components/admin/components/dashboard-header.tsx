...
export function DashboardHeader() {
  return (
    <header className="w-full h-16 flex items-center justify-between gap-4 border-b bg-background px-6">
      <SidebarTrigger className="hidden md:flex border  cursor-pointer" />
      <div className="flex items-center gap-6">
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 text-xs flex items-center justify-center bg-primary animate-pulse">
              3
            </Badge>
          </Button>
