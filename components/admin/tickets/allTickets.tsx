...
import { Clock, Eye, MessageSquare, Plus, Search } from "lucide-react";
      ...
      <div className="flex-1 space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage customer and reseller support requests
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage all customer and reseller support requests
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <Avatar className="h-8 w-8">
                            <AvatarImage
                              src={ticket.avatar || "/placeholder.svg"}
                            />
                            <AvatarFallback>
                              {ticket.user
                                .split(" ")
