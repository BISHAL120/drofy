            ...
            <div className="max-w-[1600px] mx-auto px-4 py-3">
                <div className=" mx-auto xl:px-4 pb-4 xl:pb-0 py-3 flex items-center justify-between">
                    <div className=" w-1/2 flex items-center space-x-4">
                        ...
                        <div className="w-2/3 hidden xl:flex relative">
                            <Input
                                type="search"
                    ...
                    <div className="w-1/2 flex items-center justify-end gap-8">
                        <nav className="hidden md:flex items-center space-x-6">
                            <Link href="/home" className="hover:underline">হোম
                            </Link>
                            <Link href="/about" className="hover:underline">আমাদের সম্পর্কে
                            </Link>
                            <Link href="/login" className="hover:underline">লগইন
                            </Link>
                            <Link href="/register" className="hover:underline">রেজিস্ট্রেশন
                            </Link>
                ...
                <div className="flex items-center justify-between">
                    <div className="w-[85%] flex xl:hidden relative">
                        <Input
                            type="search"
                            placeholder="Search products..."
                            className=" bg-white/90 text-black pr-10"
