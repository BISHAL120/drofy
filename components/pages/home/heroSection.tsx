        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="mb-8 lg:w-2/5">
            ...
            <div className="flex justify-center md:justify-start flex-wrap gap-2 p-2 md:p-0 md:pr-3">
              ...
              <Button
                variant="outline"
                className="w-full md:flex-1 lg:max-w-[210px] border-2 border-white/80 text-black text-base font-semibold cursor-pointer backdrop-blur-sm hover:bg-white/20 hover:border-white transform hover:scale-105 transition-all duration-300"
              >
                View Categories
              </Button>
            </div>
