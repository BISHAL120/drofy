        ...
        <footer className="bg-gray-900 text-gray-300">
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <div>
                        <h4 className="font-bold text-white text-lg mb-4">Restock BD</h4>
                        <p className="text-gray-400 mb-4">
                            Your trusted destination for online shopping with thousands of products
                            and reliable delivery services.
                        </p>
                        <div className="flex space-x-3">
                            <a href="#" className="bg-gray-800 p-2 rounded-full hover:bg-orange-500 hover:text-white transition-colors">
                                <Facebook size={18} />
                            </a>
                            <a href="#" className="bg-gray-800 p-2 rounded-full hover:bg-orange-500 hover:text-white transition-colors">
                                <Instagram size={18} />
                    ...
                    <div>
                        <h4 className="font-bold text-white text-lg mb-4">Customer Service</h4>
                        <ul className="space-y-2">
                ...
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm mb-4 md:mb-0">
                        &copy; {new Date().getFullYear()} Restock BD. All rights reserved.
                    </p>
                    <div className="flex items-center">
                        <Image width={24} height={24} src="/placeholder.svg" alt="Payment Methods" className="h-6" />
                    </div>
                </div>
            </div>
        </footer>
