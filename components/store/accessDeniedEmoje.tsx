    ...
    <div className="relative scale-75">
      ...
      <div className="ghost-container">
        <div className="ghost-body">
          ...
          <div className="ghost-part top0"></div>
          <div className="ghost-part top1"></div>
          <div className="ghost-part top2"></div>
          <div className="ghost-part top3"></div>
          <div className="ghost-part top4"></div>
          <div className="ghost-part st0"></div>
          <div className="ghost-part st1"></div>
          <div className="ghost-part st2"></div>
          <div className="ghost-part st3"></div>
          <div className="ghost-part st4"></div>
          <div className="ghost-part st5"></div>
