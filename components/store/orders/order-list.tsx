                ...
                <Link href="/store/active-orders">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="py-3 flex items-center justify-center">
                            <span className="text-sm font-medium">View Active Order (Advance Report)</span>
                        </div>
                    </div>
                </Link>
            </div>
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 lg:gap-6">
                                            ...
                                            <div className="lg:col-span-2">
                                                <div className="flex flex-col space-y-2">
                                                    <div className="flex items-center justify-between lg:justify-start lg:space-x-4">
                                                        <span className="text-sm text-gray-500">তারিখ: {order.date}</span>
                                            ...
                                            <div className="lg:col-span-2">
                                                <div className="grid grid-cols-3 gap-4 lg:gap-2">
                                                    ...
                                                    <div>
                                                        <p className="text-xs text-gray-500 mb-1">বিক্রয়</p>
                                                        <p className="font-semibold">৳{order.sold.toLocaleString()}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs text-gray-500 mb-1">প্রফিট</p>
                                                        <p className={`font-semibold ${order.profit >= 0 ? "text-green-600" : "text-red-600"}`}>
                                            ...
                                            <div className="lg:col-span-1 flex items-center justify-between lg:justify-center">
                                                <span className="text-sm text-gray-500 lg:hidden">Order #</span>
