    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="icon"
          className={cn("size-9 border-slate-600", className)}
          onClick={(event) => {
            onClick?.(event);
            toggleSidebar();
          }}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-orange-400 data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
